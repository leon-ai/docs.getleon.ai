...
Leon is still pretty young today. If you wish, you can help by [contributing](https://github.com/leon-ai/leon/blob/master/.github/CONTRIBUTING.md) ❤️
...
The Leon CLI is the companion that will help with your journey by making the setup very smooth and more!
...
By default, the CLI grabs the source code from the stable Git branch (`master`). Instead, you can also pull the source code from the `develop` Git branch which is the default branch and this is where the latest changes are merged.
...
To see what he can do, please refer to the [packages list](https://github.com/leon-ai/leon/tree/master/packages).
