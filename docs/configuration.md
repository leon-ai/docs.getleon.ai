...
| `LEON_SERVER_HOST`          | Server host. Use your machine IP address to access to Leon from the outside. | `localhost` (default) |
| `LEON_SERVER_PORT`          | Server port. | `1337` (default) |
| `LEON_WEBAPP_HOST`          | Web app host. Use your machine IP address to access to Leon from the outside. | `localhost` (default) |
